...
function to_te(verb,dan)
{
    ...
    if(dan.slice(0,2) == 'v5')   // 一类动词
    {
        var last = verb[verb.length-1];   // 判断动词结尾
...
function to_ba(verb,dan)
{
    ...
    if(dan.slice(0,2) == 'vs')   // 兼容「する」写成「為る」的写法
